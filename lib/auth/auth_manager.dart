...
abstract class AuthManager {
  ...
  Future sendEmailVerification({required AppUser user}) async {}
  Future refreshUser({required AppUser user}) async {}
}
...
mixin FacebookSignInManager on AuthManager {
  Future<AppUser?> signInWithFacebook(BuildContext context);
}
...
mixin GithubSignInManager on AuthManager {
  Future<AppUser?> signInWithGithub(BuildContext context);
}
